def filter_by_state(list_state_info: list[dict], state_info: str = "EXECUTED") -> list[dict]:
...
def sort_by_date(list_state_info: list[dict], sorting_reverse: bool = True) -> list[dict]:
